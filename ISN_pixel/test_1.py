# -*- coding: utf-8 -*-
"""
Created on Wed Feb 26 13:55:05 2020
...
def custom_pixelation(img, cell_rows, cell_columns, new_image_dimesions, median_or_mean):
	...
	new_image.show()
	new_image.save("WORKING.jpg")

image1 = Image.open("images.jpg") # The file path of the image
    
custom_pixelation(image1, 30, 30, image1.size, 'mean')
